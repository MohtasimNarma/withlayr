...
let data2 = require("../../fixtures/testdata.json")
...
describe("Test Suite for Dashboard",()=>{
    ...
    it('Enter Username and Password',()=>{
        cy.get('#login-username').type(data2.emailreg)
        cy.get('#login-password').type(data2.regpwd)
    ...
    it.skip('Click on List View',()=>{
        cy.get('[data-qa="fimudamuvo"] > a').click()
    })

    it.skip('Search on the Basis of Created',()=>{
    ...
    it.skip('Search on the Basis of Score',()=>{
